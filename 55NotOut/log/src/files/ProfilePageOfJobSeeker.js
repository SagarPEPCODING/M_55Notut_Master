...
import NewHeaderForJobSeeker from './NewHeaderForJobSeeker';
...
class ProfilePageOfJobSeeker extends Component {
  constructor(props) {
    super(props);
...
export default ProfilePageOfJobSeeker;
